...
class FetchEpisodeWiseReelsApi {
  ...
  static Future<FetchEpisodeWiseReelsModel?> callApi(
      {required String loginUserId, required String videoId, required String movieSeriesId}) async {
    Utils.showLog("Fetch Episode Wise Reels Api Calling... ", level: LogLevel.debug);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        log("Fetch Episode Wise Reels Api StateCode Error => ",
